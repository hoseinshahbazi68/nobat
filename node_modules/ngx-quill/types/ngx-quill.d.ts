...
declare abstract class QuillEditorBase implements AfterViewInit, ControlValueAccessor, OnChanges, OnInit, Validator {
    readonly format: _angular_core.InputSignal<QuillFormat>;
    readonly theme: _angular_core.InputSignal<string>;
    readonly modules: _angular_core.InputSignal<QuillModules>;
    readonly debug: _angular_core.InputSignal<false | "warn" | "log" | "error">;
    ...
    valueGetter: _angular_core.InputSignal<any>;
...
declare class QuillService {
    ...
    /** @internal */
    beforeRender(Quill: any, customModules: CustomModule[] | undefined, beforeRender?: ngx_quill.QuillBeforeRender): Observable<any>;
    /** @internal */
