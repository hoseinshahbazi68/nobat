...
import { inject, Injectable, input, EventEmitter, signal, ElementRef, ChangeDetectorRef, PLATFORM_ID, Renderer2, NgZone, DestroyRef, SecurityContext, Output, Directive, forwardRef, ViewEncapsulation, Component, provideZoneChangeDetection, NgModule } from '@angular/core';
...
class QuillEditorBase {
    constructor() {
        this.format = input(undefined, ...(ngDevMode ? [{ debugName: "format" }] : []));
        this.theme = input(undefined, ...(ngDevMode ? [{ debugName: "theme" }] : []));
        this.modules = input(undefined, ...(ngDevMode ? [{ debugName: "modules" }] : []));
        ...
        this.formats = input(undefined, ...(ngDevMode ? [{ debugName: "formats" }] : []));
        this.customToolbarPosition = input('top', ...(ngDevMode ? [{ debugName: "customToolbarPosition" }] : []));
        this.sanitize = input(undefined, ...(ngDevMode ? [{ debugName: "sanitize" }] : []));
        this.beforeRender = input(undefined, ...(ngDevMode ? [{ debugName: "beforeRender" }] : []));
        this.styles = input(null, ...(ngDevMode ? [{ debugName: "styles" }] : []));
        this.registry = input(undefined, ...(ngDevMode ? [{ debugName: "registry" }] : []));
        this.bounds = input(undefined, ...(ngDevMode ? [{ debugName: "bounds" }] : []));
        this.customOptions = input([], ...(ngDevMode ? [{ debugName: "customOptions" }] : []));
        this.customModules = input([], ...(ngDevMode ? [{ debugName: "customModules" }] : []));
        this.trackChanges = input(undefined, ...(ngDevMode ? [{ debugName: "trackChanges" }] : []));
        this.classes = input(undefined, ...(ngDevMode ? [{ debugName: "classes" }] : []));
        this.trimOnValidation = input(false, ...(ngDevMode ? [{ debugName: "trimOnValidation" }] : []));
        this.linkPlaceholder = input(undefined, ...(ngDevMode ? [{ debugName: "linkPlaceholder" }] : []));
        this.compareValues = input(false, ...(ngDevMode ? [{ debugName: "compareValues" }] : []));
        this.filterNull = input(false, ...(ngDevMode ? [{ debugName: "filterNull" }] : []));
        this.debounceTime = input(undefined, ...(ngDevMode ? [{ debugName: "debounceTime" }] : []));
...
class QuillViewHTMLComponent {
    constructor() {
        ...
        this.theme = input(undefined, ...(ngDevMode ? [{ debugName: "theme" }] : []));
        this.sanitize = input(undefined, ...(ngDevMode ? [{ debugName: "sanitize" }] : []));
        this.innerHTML = signal('', ...(ngDevMode ? [{ debugName: "innerHTML" }] : []));
        this.themeClass = signal('ql-snow', ...(ngDevMode ? [{ debugName: "themeClass" }] : []));
...
`, styles: [".ql-container.ngx-quill-view{border:0}\n"] }]
        }], propDecorators: { format: [{ type: i0.Input, args: [{ isSignal: true, alias: "format", required: false }] }], theme: [{ type: i0.Input, args: [{ isSignal: true, alias: "theme", required: false }] }], modules: [{ type: i0.Input, args: [{ isSignal: true, alias: "modules", required: false }] }], debug: [{ type: i0.Input, args: [{ isSignal: true, alias: "debug", required: false }] }], formats: [{ type: i0.Input, args: [{ isSignal: true, alias: "formats", required: false }] }], sanitize: [{ type: i0.Input, args: [{ isSignal: true, alias: "sanitize", required: false }] }], beforeRender: [{ type: i0.Input, args: [{ isSignal: true, alias: "beforeRender", required: false }] }], strict: [{ type: i0.Input, args: [{ isSignal: true, alias: "strict", required: false }] }], content: [{ type: i0.Input, args: [{ isSignal: true, alias: "content", required: false }] }], customModules: [{ type: i0.Input, args: [{ isSignal: true, alias: "customModules", required: false }] }], customOptions: [{ type: i0.Input, args: [{ isSignal: true, alias: "customOptions", required: false }] }], onEditorCreated: [{
                type: Output
            }] } });
