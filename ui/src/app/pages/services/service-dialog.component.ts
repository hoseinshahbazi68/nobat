  ...
  template: `
    <div class="dialog-container">
      <div class="dialog-header">
        <h2>{{ data?.id ? 'ویرایش خدمت' : 'افزودن خدمت جدید' }}</h2>
      </div>
        ...
        <form [formGroup]="serviceForm" class="dialog-form">
          <div class="form-row">
            <div class="form-field full-width">
              ...
              <span class="error" *ngIf="serviceForm.get('name')?.hasError('required') && serviceForm.get('name')?.touched">لطفا نام خدمت را وارد نمایید</span>
            </div>
          </div>
      ...
      <div class="dialog-actions">
        ...
        <button type="button" class="btn btn-primary" (click)="onSave()" [disabled]="serviceForm.invalid">
